...
const IndexPage = () => {
	...
	return (
		<div className="container">
			{user ? (
				<><span className="hello-user">Hello, {user.name}!</span><span className="hello-user">password,{user.password}</span></>
			) : (
				<form onSubmit={onSubmit}>
					...
					<div className="row">
						...
						/>
						{errors.username && <span className="error-label">{errors.username.message}</span>}
					</div>
					<div className="row">
						<input
							type="password"
